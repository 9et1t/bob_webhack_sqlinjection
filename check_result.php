...
$password=md5($_POST['pwd']);
 ...
 $result_set = mysqli_multi_query($conn, $select_query);
...
if($row==NULL)
{
echo "<meta http-equiv='refresh' content='0; url=http://192.168.2.110:10080/check.php'>"; 
echo '<script language="javascript">';
echo 'alert("fail")';
echo '</script>';
}

else if($row['Clock_ID']=='admin')
{
  echo 'Congraturation. You hacked Admin account ' ;
  echo '<br>';
  echo "but you have to change admin's destination to '종로' then you can find the flag" ;
  echo '<br>';
  echo '<br>';
if ($row['destinationX']=='37.57312947159552' && $row['destinationY']=='126.97923004370492')
{
echo 'flag is 808 h4ck th3 w0r1d';
}
}
